Original
```
https://editor.p5js.org/Galigali26/sketches/ly9YVRE4G
```
...
function mousePressed() {
  newShape = new Shape(color(random(360), 100, 100, 80));
  newShape.addPos(mouseX, mouseY);
}
...
function keyPressed() {
  if (key == 's' || key == 'S') saveCanvas('pendulum-modificado', 'png');
